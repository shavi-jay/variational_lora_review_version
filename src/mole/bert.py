...
from src.mole.deberta.ops import StableDropout, MaskedLayerNorm, ACT2FN
from src.mole.deberta.da_utils import build_relative_position
from src.mole.disentangled_attention import DisentangledSelfAttention
...
class MolEPredictionHead(nn.Module):
    def __init__(
        self,
        config,
        num_tasks: int = 1,
        ...
        self.classifier = torch.nn.Linear(
            self.config["hidden_size"], num_tasks * num_labels
        )
